...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.file_list.setFixedWidth(200)  # Set a fixed width for the file list
        self.layout.addWidget(self.file_list)

        # Right side layout for PDF viewer and controls
        self.right_layout = QVBoxLayout()

        self.webView = QWebEngineView()
        self.webView.settings().setAttribute(self.webView.settings().WebAttribute.PluginsEnabled, True)
        self.webView.settings().setAttribute(self.webView.settings().WebAttribute.PdfViewerEnabled, True)
        self.webView.setMaximumWidth(800)  # Set a maximum width for the PDF viewer
        ...
        # Radio buttons for marking pages
