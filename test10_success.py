    ...
    def mark_page(self):
        if self.current_file:
            if self.class1_start_radio_button.isChecked():
                self.marks['Class1_start'] = self.current_page + 1
                print(f"Start page for Class1 marked as {self.current_page + 1}")
            elif self.class1_end_radio_button.isChecked():
                self.marks['Class1_end'] = self.current_page + 1
                print(f"End page for Class1 marked as {self.current_page + 1}")
            elif self.class2_start_radio_button.isChecked():
                self.marks['Class2_start'] = self.current_page + 1
                print(f"Start page for Class2 marked as {self.current_page + 1}")
            elif self.class2_end_radio_button.isChecked():
                self.marks['Class2_end'] = self.current_page + 1
                print(f"End page for Class2 marked as {self.current_page + 1}")
